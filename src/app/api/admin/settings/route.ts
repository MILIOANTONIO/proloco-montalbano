  ...
  const [settings] = await prisma.$transaction([
    prisma.siteSettings.upsert({
      ...
      update: {
        ...
        cardPercorsoImage: body.cardPercorsoImage || null,
        cardInfoImage: body.cardInfoImage || null,
        cardEventiImage: body.cardEventiImage || null,
        cardNewsImage: body.cardNewsImage || null,
      },
      create: {
        id: "singleton",
        showAward: !!body.showAward,
