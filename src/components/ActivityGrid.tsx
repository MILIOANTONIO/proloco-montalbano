    ...
    <>
      ...
      <ul className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
        {visible.map((a) => {
          ...
          return (
            <li key={a.id} className="overflow-hidden rounded-3xl bg-white shadow-sm">
              <div className="relative aspect-[4/3] w-full bg-gradient-to-br from-brand-200 to-olive-400/40">
                {a.coverImage ? (
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <MainIcon className="h-12 w-12 text-brand-600" />
                  </div>
                )}
              ...
              <div className="space-y-2 p-4">
                <p className="font-display text-lg font-bold leading-tight text-brand-900">{a.name}</p>
                {a.description && <p className="text-sm text-brand-700">{a.description}</p>}
                ...
                <div className="flex flex-wrap items-center gap-2 pt-1">
                  ...
                  {a.phone && (
                    <a
                      ...
                      className="inline-flex items-center gap-2 rounded-full border border-brand-200 px-4 py-2.5 text-sm font-medium text-brand-700 transition-colors duration-200 hover:bg-brand-100"
                    >
                  ...
                  {a.website && (
                    <a
                      ...
                      className="inline-flex items-center rounded-full border border-brand-200 px-4 py-2.5 text-sm font-medium text-brand-700 transition-colors duration-200 hover:bg-brand-100"
                    >
                      {websiteLabel}
                    </a>
                  )}
